...
public class RegressionTestMicroController extends IntentService {
    ...
    private static final String EXTRA_CONFIG1 = "edu.hkust.cse.phoneAdapter.context.extra.PARAM1";
    private static final String EXTRA_CONFIG2 = "edu.hkust.cse.phoneAdapter.context.extra.PARAM2";
