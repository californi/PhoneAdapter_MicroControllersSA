...
public class AdaptationManagerNoRingtone extends IntentService {
    private MyDbAdapter mDbHelper;

    private Handler mHandler;

    private AdaptationManagerNoRingtone.MyBroadcastReceiver mReceiver;

    private ArrayList<AdaptationManagerNoRingtone.Rule> mRuleList;

    private AdaptationManagerNoRingtone.Profile mCurProfile;

    private ArrayList<AdaptationManagerNoRingtone.Rule> mCurRuleList;
     ...
     */
    public AdaptationManagerNoRingtone(){
        super("AdaptationManagerNoRingtone");
    }
    ...
    public void onCreate() {
        ...
        mReceiver=new AdaptationManagerNoRingtone.MyBroadcastReceiver();
        ...
        fetchRulesFromDb();
        mCurProfile=new AdaptationManagerNoRingtone.Profile();
        ...
        mCurRuleList=new ArrayList<AdaptationManagerNoRingtone.Rule>();
        ...
        AdaptationManagerNoRingtone.running = true;
    }
    ...
    public void onDestroy() {
        ...
        AdaptationManagerNoRingtone.running = false;
     ...
     */
    private ArrayList<AdaptationManagerNoRingtone.Rule> fetchRulesFromDb(){
        ArrayList<AdaptationManagerNoRingtone.Rule> list=new ArrayList<AdaptationManagerNoRingtone.Rule>();
        Cursor c=mDbHelper.fetchAllEnabledRules();
        if(c.getCount()>0){
            c.moveToFirst();
            while(!c.isAfterLast()){
                AdaptationManagerNoRingtone.Rule r=new AdaptationManagerNoRingtone.Rule();
                AdaptationManagerNoRingtone.Profile curP=new AdaptationManagerNoRingtone.Profile();
                AdaptationManagerNoRingtone.Profile newP=new AdaptationManagerNoRingtone.Profile();
                ArrayList<AdaptationManagerNoRingtone.Filter> fList=new ArrayList<AdaptationManagerNoRingtone.Filter>();
                ...
                if(tempC.getCount()<=0){
                    ...
                    while(!tempC.isAfterLast()){
                        AdaptationManagerNoRingtone.Filter f=new AdaptationManagerNoRingtone.Filter();
    ...
    public static boolean isRunning(){
        return AdaptationManagerNoRingtone.running;
    }
            ...
            if(action.equals("edu.hkust.cse.phoneAdapter.newContext")){
                ...
                while(true){
                    ...
                    if(mCurRuleList.size()>0){
                        ArrayList<AdaptationManagerNoRingtone.Rule> satisfiedRuleList=checkRules(mCurRuleList, i);
                        if(satisfiedRuleList.size()==0){
                            ...
                            try {
                                ...
                                intentActuatorData.putExtra(ContextName.VIBRATION, true);
                                intentActuatorData.putExtra(ContextName.CURRENT_ADAPTATIONMANAGER, "NoRingtone");
                            ...
                            ArrayList<AdaptationManagerNoRingtone.Rule> candidate=new ArrayList<AdaptationManagerNoRingtone.Rule>();
...
//				});
     ...
     */
    private static ArrayList<AdaptationManagerNoRingtone.Rule> checkRules(ArrayList<AdaptationManagerNoRingtone.Rule> ruleList, Intent i){
        ArrayList<AdaptationManagerNoRingtone.Rule> result=new ArrayList<AdaptationManagerNoRingtone.Rule>();
        ...
        for(int j=0;j<ruleList.size();j++){
            ArrayList<AdaptationManagerNoRingtone.Filter> fList=ruleList.get(j).filterList;
            boolean f=true;
            for(int k=0;k<fList.size();k++){
                /* if any filter is not satisfied,break and set f to false */
                AdaptationManagerNoRingtone.Filter filter=fList.get(k);
    ...
    private class Rule{
        ...
        private AdaptationManagerNoRingtone.Profile currentProfile;
        private ArrayList<AdaptationManagerNoRingtone.Filter> filterList;
        private AdaptationManagerNoRingtone.Profile newProfile;
