...
public class AdaptationManagerNoRingtoneNoVibration extends IntentService {

    private MyDbAdapter mDbHelper;
    private Handler mHandler;
    private AdaptationManagerNoRingtoneNoVibration.MyBroadcastReceiver mReceiver;
    private ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> mRuleList;
    private AdaptationManagerNoRingtoneNoVibration.Profile mCurProfile;
    private ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> mCurRuleList;
     ...
     */
    public AdaptationManagerNoRingtoneNoVibration(){
        super("AdaptationManagerNoRingtoneNoVibration");
    }
    ...
    public void onCreate() {
        ...
        mReceiver = new AdaptationManagerNoRingtoneNoVibration.MyBroadcastReceiver();
        ...
        fetchRulesFromDb();
        mCurProfile=new AdaptationManagerNoRingtoneNoVibration.Profile();
        ...
        mCurRuleList=new ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule>();
        ...
        AdaptationManagerNoRingtoneNoVibration.running = true;
    }
    ...
    public void onDestroy() {
        ...
        AdaptationManagerNoRingtoneNoVibration.running = false;
     ...
     */
    private ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> fetchRulesFromDb(){
        ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> list=new ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule>();
        Cursor c=mDbHelper.fetchAllEnabledRules();
        if(c.getCount()>0){
            c.moveToFirst();
            while(!c.isAfterLast()){
                AdaptationManagerNoRingtoneNoVibration.Rule r=new AdaptationManagerNoRingtoneNoVibration.Rule();
                AdaptationManagerNoRingtoneNoVibration.Profile curP=new AdaptationManagerNoRingtoneNoVibration.Profile();
                AdaptationManagerNoRingtoneNoVibration.Profile newP=new AdaptationManagerNoRingtoneNoVibration.Profile();
                ArrayList<AdaptationManagerNoRingtoneNoVibration.Filter> fList=new ArrayList<AdaptationManagerNoRingtoneNoVibration.Filter>();
                ...
                if(tempC.getCount()<=0){
                    ...
                    while(!tempC.isAfterLast()){
                        AdaptationManagerNoRingtoneNoVibration.Filter f=new AdaptationManagerNoRingtoneNoVibration.Filter();
    ...
    public static boolean isRunning(){
        return AdaptationManagerNoRingtoneNoVibration.running;
    }
            ...
            if(action.equals("edu.hkust.cse.phoneAdapter.newContext")){
                ...
                while(true){
                    ...
                    if(mCurRuleList.size()>0){
                        ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> satisfiedRuleList=checkRules(mCurRuleList, i);
                        if(satisfiedRuleList.size()==0){
                            ...
                            ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> candidate=new ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule>();
...
//				});
     ...
     */
    private static ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> checkRules(ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> ruleList, Intent i){
        ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule> result=new ArrayList<AdaptationManagerNoRingtoneNoVibration.Rule>();
        ...
        for(int j=0;j<ruleList.size();j++){
            ArrayList<AdaptationManagerNoRingtoneNoVibration.Filter> fList=ruleList.get(j).filterList;
            boolean f=true;
    ...
    private class Rule{
        ...
        private AdaptationManagerNoRingtoneNoVibration.Profile currentProfile;
        private ArrayList<AdaptationManagerNoRingtoneNoVibration.Filter> filterList;
        private AdaptationManagerNoRingtoneNoVibration.Profile newProfile;
