...
/**
 * The Class AdaptationManagerAllEffectors.
 * @author andrew
 */
public class AdaptationManagerAllEffectors extends IntentService {
	 ...
	 */
	public AdaptationManagerAllEffectors(){
		super("AdaptationManagerAllEffectors");
	}
	...
	public void onCreate() {
		...
		AdaptationManagerAllEffectors.running = true;
	}
	...
	public void onDestroy() {
		...
		AdaptationManagerAllEffectors.running = false;
...
/** indicate whether the service is running or not*/
	...
	public static boolean isRunning(){
		return AdaptationManagerAllEffectors.running;
	}
	...
	private class MyBroadcastReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context c, Intent i) {
            ...
            Log.i("Testing", "onReceive MyBroadcastReceiver AdaptataionManagerAllEffectors" + Thread.currentThread().getName());
					...
					if(mCurRuleList.size()>0){
						...
						if(satisfiedRuleList.size()==0){
							...
							try{
								...
								intentActuatorData.putExtra(ContextName.CURRENT_ADAPTATIONMANAGER, "AllEffectors");
