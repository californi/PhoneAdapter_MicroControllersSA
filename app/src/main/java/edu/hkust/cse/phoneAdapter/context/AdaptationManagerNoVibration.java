...
public class AdaptationManagerNoVibration extends IntentService {
    private MyDbAdapter mDbHelper;
    private Handler mHandler;
    private AdaptationManagerNoVibration.MyBroadcastReceiver mReceiver;
    private ArrayList<AdaptationManagerNoVibration.Rule> mRuleList;
    private AdaptationManagerNoVibration.Profile mCurProfile;
    private ArrayList<AdaptationManagerNoVibration.Rule> mCurRuleList;
     ...
     */
    public AdaptationManagerNoVibration(){
        super("AdaptationManagerNoVibration");
    }
    ...
    public void onCreate() {
        ...
        mReceiver=new AdaptationManagerNoVibration.MyBroadcastReceiver();
        ...
        fetchRulesFromDb();
        mCurProfile=new AdaptationManagerNoVibration.Profile();
        ...
        mCurRuleList=new ArrayList<AdaptationManagerNoVibration.Rule>();
        ...
        AdaptationManagerNoVibration.running = true;
    }
    ...
    public void onDestroy() {
        ...
        AdaptationManagerNoVibration.running = false;
     ...
     */
    private ArrayList<AdaptationManagerNoVibration.Rule> fetchRulesFromDb(){
        ArrayList<AdaptationManagerNoVibration.Rule> list=new ArrayList<AdaptationManagerNoVibration.Rule>();
        Cursor c=mDbHelper.fetchAllEnabledRules();
        if(c.getCount()>0){
            c.moveToFirst();
            while(!c.isAfterLast()){
                AdaptationManagerNoVibration.Rule r=new AdaptationManagerNoVibration.Rule();
                AdaptationManagerNoVibration.Profile curP=new AdaptationManagerNoVibration.Profile();
                AdaptationManagerNoVibration.Profile newP=new AdaptationManagerNoVibration.Profile();
                ArrayList<AdaptationManagerNoVibration.Filter> fList=new ArrayList<AdaptationManagerNoVibration.Filter>();
                ...
                if(tempC.getCount()<=0){
                    ...
                    while(!tempC.isAfterLast()){
                        AdaptationManagerNoVibration.Filter f=new AdaptationManagerNoVibration.Filter();
    ...
    public static boolean isRunning(){
        return AdaptationManagerNoVibration.running;
    }
            ...
            if(action.equals("edu.hkust.cse.phoneAdapter.newContext")){
                ...
                while(true){
                    ...
                    if(mCurRuleList.size()>0){
                        ArrayList<AdaptationManagerNoVibration.Rule> satisfiedRuleList=checkRules(mCurRuleList, i);
                        if(satisfiedRuleList.size()==0){
                            ...
                            ArrayList<AdaptationManagerNoVibration.Rule> candidate=new ArrayList<AdaptationManagerNoVibration.Rule>();
...
//				});
     ...
     */
    private static ArrayList<AdaptationManagerNoVibration.Rule> checkRules(ArrayList<AdaptationManagerNoVibration.Rule> ruleList, Intent i){
        ArrayList<AdaptationManagerNoVibration.Rule> result=new ArrayList<AdaptationManagerNoVibration.Rule>();
        ...
        for(int j=0;j<ruleList.size();j++){
            ArrayList<AdaptationManagerNoVibration.Filter> fList=ruleList.get(j).filterList;
            boolean f=true;
    ...
    private class Rule{
        ...
        private AdaptationManagerNoVibration.Profile currentProfile;
        private ArrayList<AdaptationManagerNoVibration.Filter> filterList;
        private AdaptationManagerNoVibration.Profile newProfile;
